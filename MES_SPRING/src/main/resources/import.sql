...
(2, '이용현', 'dfgr56@naver.com', '$2a$10$z5fqAUASGYYwOxJgnodXPOiHNgbTaVLV39hlh0WE0Z3ai6/rDCdha', 'ROLE_PRODUCTION_ADMIN', 'ACTIVE'),
...
(7, 1, 1, 'CMP', 'LOT-1401', 350, 5, 'DONE', CURRENT_DATE, CURRENT_DATE + INTERVAL 10 HOUR, CURRENT_DATE + INTERVAL 12 HOUR + INTERVAL 5 MINUTE, 'INFO', 'PRODUCTION', '12시 CMP 공정 완료'),
(8, 1, 1, 'CMP', 'LOT-1601', 370, 6, 'DONE', CURRENT_DATE, CURRENT_DATE + INTERVAL 10 HOUR, CURRENT_DATE + INTERVAL 12 HOUR + INTERVAL 10 MINUTE, 'WARN', 'PRODUCTION', '12시 CMP 진동 감지');
